...
public class ReactAgentConfig {
    ...
    @Bean("chatReactAgent")
    public ReactAgent chatReactAgent(ChatModel chatModel, SummarizationHook summarizationHook, MemorySaver memorySaver) {
    ...
    @Bean("ragReactAgent")
    public ReactAgent ragReactAgent(ChatModel chatModel, SummarizationHook summarizationHook, MemorySaver memorySaver) {
        return ReactAgent.builder()
                .name("rag_agent")
                .model(chatModel)
